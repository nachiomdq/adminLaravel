...
class SubCategoriesController extends Controller
{
    public function getDelete($categoryID){
      try {
        ...
        $category = Subcategories::find($categoryID);
        $category->delete();
        $r = new ApiResponse();
        $r->success = true;
    ...
    public function getRecover($categoryID){
      try {
        ...
        $category = Subcategories::onlyTrashed()->find($categoryID);
        $category->restore();
        $r = new ApiResponse();
        $r->success = true;
    ...
    public function getList(Request $request){
      try {
          ...
          $collection= Subcategories::getSubCategories(
                                $status,
                                $filters['take'],
                                $filters['offset']
                                );
          ...
          $r->recordsTotal = Subcategories::getSubCategoriesCount($status);
          $r->recordsFiltered = Subcategories::getSubCategoriesCount($status);
          $r->success = true;
    ...
    public function postEdit(Request $request, $categoryID){
      try {
          ...
          $element = Subcategories::find($categoryID);
    ...
    public static function checkFriendlyUrl($url){
      ...
      $elementCheck = Subcategories::where('friendly_url',$url)->get();
