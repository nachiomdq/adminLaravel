                ...
                <div class="col-sm-12">
                    <div class="form-group">
                      <div class="col-xs-12">
                        ...
                        <input class="form-control input-lg" type="text" id="button_text" name="button_text" value="">
                      </div>
                ...
                <div class="row">
                 <div class="col-sm-12">
                     <div class="form-group">
                       ...
                       <div class="col-xs-12">
                         <label for="name">Asociar enlace a </label>
                          <div class="row">
                            <div class="col-xs-3">
                              <label class="css-input css-radio css-radio-default">
                                  <input type="radio" value="product" name="radio-group1"><span></span> Producto
                              </label>
                            </div>
                            <div class="col-xs-6 hide selprod">
                         ...
                         <div class="row">
                             <div class="col-xs-3">
                               <label class="css-input css-radio css-radio-default">
                                   <input type="radio" value="promotion" name="radio-group1"><span></span> Promoción
                               </label>
                             </div>
                               <div class="col-xs-6 hide selprom">
                         ...
                         <div class="row">
                             <div class="col-xs-3">
                               <label class="css-input css-radio css-radio-default">
                                   <input type="radio" value="other" name="radio-group1"><span></span> Otro
                               </label>
                             </div>
                             <div class="col-xs-6 hide selother">
                               <input type="text" class="form-control" name="other_url" placeholder="Ejemplo: http://google.com" value="">
                             </div>
                         </div>
...
var urlAPI = "{{ url('api/sliders/create/') }}";
