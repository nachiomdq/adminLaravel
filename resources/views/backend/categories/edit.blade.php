          ...
          <div class="row items-push">
              <div class="col-sm-8">
                  <h1 class="page-heading">
                      Edición de categoría  <small>{{$category->name}}</small>
                  </h1>
              </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                      <div class="col-xs-12">
                        ...
                        <input class="form-control input-lg" type="text" id="name" name="name" value="{{$category->name}}">
                      </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                      <div class="col-xs-12">
                        ...
                        <textarea class="form-control" name="descripcion">{{$category->description}}</textarea>
                      </div>
                          ...
                          <div class="fileinput fileinput-exists" data-provides="fileinput">
                            ...
                            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;">
                              @if($category->cover_image)
                                   <img src="{{asset('storage/categories/' . $category->cover_image)}}" class="img-responsive" alt="">
                               @else
                                 	  <img src="http://placehold.it/200x150">
                               @endif
                    ...
                    <div class="form-group">
                      <div class="col-xs-12">
                        <label for="name">URL SEO</label>
                          ...
                          <input  class="form-control input-lg" type="text" name="friendly_url" id="friendly_url" value="{{$category->friendly_url}}">
...
var urlAPI = "{{ url('api/categories/edit/'.$category->id) }}";
